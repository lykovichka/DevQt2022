...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonDoubleSpinBox.clicked.connect(lambda: self.plainTextEditLog.setPlainText(str(self.doubleSpinBox.value()))) # TODO подключить слот для вывода значения из doubleSpinBox в plainTextEditLog при нажатии на кнопку
        self.pushButtonTimeEdit.clicked.connect(lambda: self.plainTextEditLog.setPlainText(str(self.timeEdit.text()))) # TODO подключить слот для вывода времени из timeEdit в plainTextEditLog при нажатии на кнопку
        self.pushButtonDateTimeEdit.clicked.connect(lambda:self.plainTextEditLog.setPlainText(str(self.dateTimeEdit.text()))) # TODO подключить слот для вывода времени из dateTimeEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.dateTimeEdit.dateTimeChanged.connect(lambda:self.plainTextEditLog.setPlainText((str(self.dateTimeEdit.text()))))  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
